...
<body class="font-sans antialiased bg-gray-50">
    ...
    <aside id="sidebar"
        ...
        aria-label="Sidebar">
        <div class="h-full flex flex-col justify-between bg-gray-900">
                    ...
                    @if (auth()->user()->esAdmin())
                        ...
                        <li>
                            <a href="{{ route('cotizaciones.index') }}"
                                class="flex items-center p-2 rounded-lg text-white hover:bg-gray-700 group {{ request()->routeIs('cotizaciones.*') ? 'bg-gray-700' : '' }}">
    ...
    <div class="sm:ml-64 min-h-screen flex flex-col">
        ...
        <!-- Topbar -->
        <nav class="sticky top-0 z-30 bg-white border-b border-gray-200 px-4 py-3 flex items-center justify-between">
